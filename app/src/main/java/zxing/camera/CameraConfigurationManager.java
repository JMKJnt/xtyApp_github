...
final class CameraConfigurationManager {
	...
	/**
	 * Reads, one time, values from the zxing_camera that are needed by the app.
	 */
	...
	/**
	 * Sets the zxing_camera up to take preview images which are used for both preview
	...
	void setDesiredCameraParameters(Camera camera) {
		...
		// modify here
		// zxing_camera.setDisplayOrientation(90);
	...
	private static Point getCameraResolution(Camera.Parameters parameters,
		...
		if (cameraResolution == null) {
			// Ensure that the zxing_camera resolution is a multiple of 8, as the
			// screen may not be.
