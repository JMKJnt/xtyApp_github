...
public class HttpApiClient_zumelAPPInterface extends HttpApiClient{
    public final static String HOST = "303f2228e57c485f91735f5683d12fc9-cn-beijing.alicloudapi.com";
    static HttpApiClient_zumelAPPInterface instance = new HttpApiClient_zumelAPPInterface();
    public static HttpApiClient_zumelAPPInterface getInstance(){return instance;}
