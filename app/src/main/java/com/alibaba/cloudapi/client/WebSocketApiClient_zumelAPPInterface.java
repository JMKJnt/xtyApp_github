...
public class WebSocketApiClient_zumelAPPInterface extends WebSocketApiClient{
    public final static String HOST = "303f2228e57c485f91735f5683d12fc9-cn-beijing.alicloudapi.com";
    static WebSocketApiClient_zumelAPPInterface instance = new WebSocketApiClient_zumelAPPInterface();
    public static WebSocketApiClient_zumelAPPInterface getInstance(){return instance;}
